...
CREATE TABLE `enroll` (
  ...
  `attendance_msg` varchar(20) DEFAULT NULL,
  `attendance_desciption` varchar(100) DEFAULT NULL,
  `s_id` int DEFAULT NULL,
  `login_id` varchar(100) DEFAULT NULL,
...
INSERT INTO `enroll` VALUES (6,0,'2024-11-16 02:12:06',NULL,NULL,NULL,5,'admin'),(7,0,'2024-11-16 02:16:37',NULL,NULL,NULL,5,'user'),(8,1,'2024-11-16 02:16:48',NULL,NULL,NULL,5,'user2');
...
INSERT INTO `user` VALUES ('admin','1234',90,'1','관리자','1','2024-11-12 15:18:19','1234@naver.com','01012341234','12344321',16983,'그룹장','IT전략실'),('user','1234',0,'1','유저1','0','2024-11-13 11:40:10','222@naver.com','01011111111','13591359',16984,'그룹장','경영지원팀'),('user2','1234',0,'1','유저2','0','2024-11-16 02:16:16','3333@naver.com','01022222222','15411541',16985,'그룹장','리더십팀');
...
-- Dump completed on 2024-11-18 17:38:28
